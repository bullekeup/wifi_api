...
/**
 * \fn int wifi_add_mesh_path(const char* name, const u_int8_t* dest, const u_int8_t* next_hop, struct wifi_nlstate* nlstate)
...
/**
 * \fn int wifi_get_mesh_path(struct list_head* lmp, const char* name, struct wifi_nlstate* nlstate)
...
/**
 * \fn int wifi_del_mesh_path(const char* name, const u_int8_t* dest, struct wifi_nlstate* nlstate)
